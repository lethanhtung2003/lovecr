document.write('<style>body{padding-bottom:0px}#e_tientv_left{display:none;position:fixed;z-index:9999;top:0;left:0}#e_tientv_right{display:none;position:fixed;z-index:9999;top:0;right:0}#e_tientv_footer{display:none;position:fixed;z-index:9999;bottom:-50px;left:0;width:100%;height:104px;background:url(https://tientv.com/noel/ft.png) repeat-x bottom left}#e_tientv_bottom_left{display:none;position:fixed;z-index:9999;bottom:20px;left:20px}@media (min-width: 992px){#e_tientv_left,#e_tientv_right,#e_tientv_footer,#e_tientv_bottom_left{display:block}}</style><img id="e_tientv_left" src="https://tientv.com/noel/topleft.png"/><img id="e_tientv_right" src="https://tientv.com/noel/topright.png"/><div id="e_tientv_footer"></div><img id="e_tientv_bottom_left" src="https://tientv.com/noel/bottomleft.png"/><div style="position:fixed;z-index:9999;bottom:3px;right:3px; font-size:12px;color:#8D8D8D;">LÊ THANH TÙNG </div>');
